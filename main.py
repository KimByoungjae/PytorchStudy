...
parser.add_argument('-test-interval', type=int, default=50, help='how many steps to wait before testing [default: 100]')
...
glove = mydatasets.load_pre_emb('./glove.6B.300d.txt', word_to_idx)
